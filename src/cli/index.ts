...
program
  ...
  .option('-m, --model <model>', 'Model to use (auto, sonnet, opus, gemini)', 'auto')
...
program
  ...
  .option('--think', 'Force reasoning model (Opus/Grok-4)')
  .option('--fast', 'Force fastest model (Gemini Flash)')
...
program
  ...
  .option('-m, --model <model>', 'Model to use (default: claude-sonnet-4)', 'claude-sonnet-4')
